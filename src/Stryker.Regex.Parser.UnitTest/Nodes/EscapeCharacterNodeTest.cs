...
namespace Stryker.Regex.Parser.UnitTest.Nodes
{
    ...
    public class EscapeCharacterNodeTest
    {
        ...
        {
            // Act
            EscapeCharacterNode result = EscapeCharacterNode.FromCharacter(escape);
        ...
        {
            // Act
            EscapeCharacterNode result = EscapeCharacterNode.FromCharacter(metacharacter);
        ...
        {
            // Act
            EscapeCharacterNode result = EscapeCharacterNode.FromHex(hex);
        ...
        {
            // Act
            EscapeCharacterNode result = EscapeCharacterNode.FromUnicode(hex);
        ...
        {
            // Act
            EscapeCharacterNode result = EscapeCharacterNode.FromOctal(oct);
        ...
        {
            // Act
            EscapeCharacterNode result = EscapeCharacterNode.FromControlCharacter(control);
        ...
        {
            // Arrange
            EscapeCharacterNode target = EscapeCharacterNode.FromCharacter('a');
            ...
            // Assert
            EscapeCharacterNode escapeNode = result.ShouldBeOfType<EscapeCharacterNode>();
