...
namespace Stryker.Regex.Parser.UnitTest.Nodes
{
    ...
    public class RegexNodeTest
    {
        ...
        {
            // Arrange
            TestRegexNode target = new(new List<RegexNode> { new CharacterNode('a'), new CharacterNode('b') });
        ...
        {
            // Arrange
            ConcatenationNode grandChildConcatNode = new(new List<RegexNode> { new CharacterNode('d'), new CharacterNode('e') });
            ConcatenationNode childConcatNode = new(new List<RegexNode> { grandChildConcatNode, new CharacterNode('a'), new CharacterNode('b') });
        ...
        public void AddNodeShouldReturnRootNode()
        {
            ...
            // Assert
            RegexNode copiedTargetParent = result.ChildNodes.ShouldHaveSingleItem();
            RegexNode modifiedTarget = copiedTargetParent.ChildNodes.ShouldHaveSingleItem();
        ...
        public void ReplaceNodeShouldReturnRootNode()
        {
            ...
            // Assert
            RegexNode copiedTargetParent = result.ChildNodes.ShouldHaveSingleItem();
            RegexNode modifierTarget = copiedTargetParent.ChildNodes.ShouldHaveSingleItem();
        ...
        public void RemoveNodeShouldCopyNodeAndRemoveOldNode()
        {
            ...
            // Assert
            RegexNode childNode = result.ChildNodes.ShouldHaveSingleItem();
        ...
        public void RemoveNodeShouldReturnRootNode()
        {
            ...
            // Assert
            RegexNode copiedTargetParentNode = result.ChildNodes.ShouldHaveSingleItem();
            RegexNode modifiedNode = copiedTargetParentNode.ChildNodes.ShouldHaveSingleItem();
        ...
        public void RemoveNodeShouldMoveOldNodesPrefixToNextNodeInTheCopy()
        {
            ...
            ConcatenationNode target = new(new List<RegexNode> { oldNode, nextNode });

            // Act
            RegexNode result = target.RemoveNode(oldNode);

            // Assert
            RegexNode remainingNode = result.ChildNodes.ShouldHaveSingleItem();
        ...
        public void RemoveNodeShouldAddEmptyNodeWithOldNodesPrefixIfThereAreNoNextNodes()
        {
            ...
            var prefix = new CommentGroupNode("This is a prefix.");
            TestRegexNode oldNode = new() { Prefix = prefix };
            ConcatenationNode target = new(new List<RegexNode> { oldNode });

            // Act
            RegexNode result = target.RemoveNode(oldNode);

            // Assert
            EmptyNode emptyNode = result.ChildNodes.ShouldHaveSingleItem().ShouldBeOfType<EmptyNode>();
